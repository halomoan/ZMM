class ZCL_MARKETLIST_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_MARKETLIST_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_MARKETLIST_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_MARKETLIST_AREA
    raising
      CX_SHM_INCONSISTENT
...
CLASS ZCL_MARKETLIST_AREA IMPLEMENTATION.
