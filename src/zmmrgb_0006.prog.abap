...
* I N C L U D E S
*----------------------------------------------------------------------*
INCLUDE zmmrgb_0006_top. " Data declarations

INCLUDE zmmrgb_0006_fetch_sub. " Subroutines
...
*Call function module to fetch relevant POS.
  REFRESH : s_ebeln,it_zpogr.
...
*Populate POs to S_EBELN
    LOOP AT it_zpogr INTO gs_zpogr.
      s_ebeln-sign   = c_i.
      s_ebeln-option = c_eq.
      s_ebeln-low    = gs_zpogr.
      APPEND s_ebeln.
    ENDLOOP.
  ENDIF.
