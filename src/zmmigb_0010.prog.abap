...
*&---------------------------------------------------------------------*
REPORT  zmmigb_0010 LINE-SIZE 500.
...
*      WHERE matnr = lv_matnr.
    ...
    PERFORM populate_bdc_tab USING:
      ...
      ' ' lv_IDNLF     fc_rfq-IDNLF.   "lv_mara_IDNLF.
