...
TABLES: ekko, lfa1, adrc, usr01, t001w, t024, zbcgb_logo, erev, zmm_PO_EMAIL. "Sun WU
...
DATA: BEGIN OF it_itemtax OCCURS 0,
        ebelp       TYPE ebelp,
        matnr       TYPE matnr,
        txt1(30)    TYPE c,
        menge       TYPE bstmg,
        ...
        kbetr_t     TYPE char11,
        amount(17)  TYPE c,
        disc        TYPE char14,          "discount
        taxrate     TYPE char8,
        taxamount   TYPE char15,
        netwr_t(17) TYPE c,
      END OF it_itemtax.
DATA w_itemtax LIKE it_itemtax.

DATA v_totalamt TYPE netwr.
DATA v_totaltxt TYPE char20.
...
*End on 15th Feb
        ...
        out_line2(30)  TYPE c,
        out_line3(30)  TYPE c,
*Start of  changes by Venkatesh<VEGOPALARATH> on 24-Jan-2011
        out_line4(30)  TYPE c,
        out_line5(30)  TYPE c,
        out_line6(30)  TYPE c,
        out_line7(30)  TYPE c,
        out_line8(30)  TYPE c,
        out_line9(30)  TYPE c,
        out_line10(30) TYPE c,
*End of  changes by Venkatesh<VEGOPALARATH> on 24-Jan-2011
        ablad          TYPE ablad,
      END OF it_ekpo,
...
CONSTANTS: c_formname(20) TYPE c VALUE 'ZMMGB_POFORM_NEW',
           c_sapf08       TYPE party VALUE 'SAPF08'.
...
*Start of changes by Venkatesh <VEGOPALARATH> on 24-Jan-2011
      v_out_line4(30)  TYPE c,
      v_out_line5(30)  TYPE c,
      v_out_line6(30)  TYPE c,
      v_out_line7(30)  TYPE c,
      v_out_line8(30)  TYPE c,
      v_out_line9(30)  TYPE c,
      v_out_line10(30) TYPE c,
*End of changes by Venkatesh <VEGOPALARATH> on 24-Jan-2011
      v_ablad          TYPE ablad,
      v_disc           TYPE kwert,
      v_kbetr(10)      TYPE p DECIMALS 3,
      v_msehl          TYPE msehl,
      v_mseh3          TYPE mseh3,
      ...
      v_adrnr1         TYPE ad_addrnum,
      wa_adr2          TYPE adr2,
      wa_adr3          TYPE adr3,
      v_tele           TYPE ad_telnrlg,
      v_telefto        TYPE sktelfto,
      v_fax            TYPE ad_fxnrlng,
      intnast          LIKE snast,
      lvs_sender       LIKE swotobjid,
      v_zterm          TYPE dztage,
      v_vtele          TYPE ad_telnrlg,
      v_vtelefto       TYPE sktelfto,
      v_vfax           TYPE ad_fxnrlng,
      wa_vadr2         TYPE adr2,
      wa_vadr3         TYPE adr3,
      v_eikto          TYPE lfm1-eikto, " added nma 13042012
      v_email          type zmm_PO_EMAIl-SMTP_ADDR, " Sun Wu
      wa_lfm1          TYPE lfm1,   "added nma 13042012
      v_maktx          TYPE makt-maktx,                     "P30K903197
      land1            TYPE t001-land1.
* ended by sjswee on 8 Nov 2010.

*Start of changes by Venkatesh <VEGOPALARATH> on 24-Jan-2011
*Long Text related changes
TYPES: BEGIN OF ty_ltext,
         text(2000) TYPE c,
       END OF ty_ltext.

DATA: it_ltext TYPE STANDARD TABLE OF ty_ltext,
      wa_ltext TYPE ty_ltext.
*End of changes by Venkatesh <VEGOPALARATH> on 24-Jan-2011

*Addition on 15th Feb
DATA : kbetr_t TYPE char18,
       amount  TYPE char18,
       disc    TYPE char18,
       netwr_t TYPE char18.
*end on 15th Feb
