...
CONSTANTS:
      ...
      OBJEKTART_R1 LIKE IONR-OBART VALUE 'R1', "Erw. Risikoträger
      OBJEKTART_R2 LIKE IONR-OBART VALUE 'R2', "Ext. Risikoträger
      OBJEKTART_R3 LIKE IONR-OBART VALUE 'R3', "Bestand Risikoträger
